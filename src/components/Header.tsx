          ...
          <div className="flex items-center gap-1.5 sm:gap-2.5 shrink-0">
            ...
            <div className="relative">
              <button
                ...
                title={`Profil: ${currentProfile.nama} (${currentProfile.role})`}
              ...
              {isProfileMenuOpen && (
                <div className="absolute right-0 mt-2 w-76 max-w-[calc(100vw-1.5rem)] bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl shadow-2xl py-2 z-50 animate-fade-in">
                  <div className="px-3.5 py-2.5 border-b border-slate-100 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-850">
                    <div className="flex items-center justify-between">
                      <p className="text-[11px] text-slate-400 uppercase tracking-wider font-extrabold">
                        Sesi Akun Google
                      </p>
                      <span className="text-[10px] bg-emerald-100 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-400 font-bold px-1.5 py-0.5 rounded">
                        Aktif
                      </span>
                    </div>
                  ...
                  <div className="p-2 border-b border-slate-100 dark:border-slate-700">
                    <p className="text-[10px] uppercase tracking-wider font-bold text-slate-400 px-2 mb-1">
                      Simulasi Ganti Akun & RBAC
                    </p>
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-center gap-2">
                              <img
                                src={profile.fotoUrl || 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=160&q=80'}
                                alt={profile.nama}
                                className="w-6 h-6 rounded-full object-cover shrink-0"
                              />
                              <div className="min-w-0">
                                <div className="font-semibold text-[11px] truncate">{profile.nama}</div>
                  ...
                  {/* Master Admin / Pengurus Quick Link */}
                  {(isMasterAdmin || isPengurus) && (
                    <div className="px-2 py-1.5 border-b border-slate-100 dark:border-slate-700">
                      <button
                        ...
                        className="w-full flex items-center gap-2 px-3 py-2 text-xs font-bold text-orange-600 dark:text-orange-400 hover:bg-orange-50 dark:hover:bg-orange-950/40 rounded-xl transition cursor-pointer"
                      >
                        <UserCog className="w-4 h-4" />
                        <span>Buka MASTER_PENGGUNA</span>
                      </button>
                    </div>
                  )}
                  ...
                  <div className="p-2">
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 px-3 py-2 text-xs font-bold text-red-600 hover:bg-red-50 dark:hover:bg-red-950/40 rounded-xl transition cursor-pointer"
                    >
